Creation of a user interface using a Basys3 card to control the speed and activation/deactivation of various functions such as headlight calls or sound
