...
set_property PACKAGE_PIN T17 [get_ports {boutons_tri_i[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {boutons_tri_i[3]}]
set_property PACKAGE_PIN U17 [get_ports {boutons_tri_i[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {boutons_tri_i[4]}]
